...
import net.sourceforge.spnego.SpnegoAccessControl;
...
/**
 * This is a copy of net.sourceforge.spnego.SpnegoHttpServletRequest class (version r9)
 * Only the package is different. This class is required by ConfigurableSpnegoHttpFilter
 *
